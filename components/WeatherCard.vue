...
const { data: {_rawValue: today} } = await useFetch('https://api.openweathermap.org/data/2.5/weather?q=harbin&appid=a77c0b06ac25cd5a0f5cab55eea00cb7&units=metric')
const { data: { _rawValue: nextDays} } = await useFetch ('https://api.openweathermap.org/data/2.5/forecast?q=tirana&appid=a77c0b06ac25cd5a0f5cab55eea00cb7')
console.log(today);
